...
const smoothShader = require('../_shaders/landscape/fragment/smooth.glsl');
const celShader = require('../_shaders/landscape/fragment/cel.glsl');
...
function initLandscapeFrame(
  ...
  return new RenderFrame({
    ...
    shader: new Shader({
      gl,
      vertexShader: require('../_shaders/landscape/vertex.glsl'),
      fragmentShader,
      attributes: {
        aPlaneVertex: {
